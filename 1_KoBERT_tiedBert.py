...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--num_epochs', type=int, default=50, help='give a epochs for training')
    ...
    tail = '/1_tiedBERT_updateClassifier/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}'
