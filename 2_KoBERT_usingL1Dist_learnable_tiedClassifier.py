...
if __name__ == '__main__':
    ...
    parser.add_argument('--cuda', type=int, default=5, help='available gpu number(only multi-gpu)')
    ...
    tail = '/Eudist_2_tiedClassifier/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}_act_{args.act}'
    ...
    train_loss.load_state_dict(torch.load("/home/data5/byeongjuncho/SentenceEmbedding/output/Eudist_1_tiedBERT/1dense_epoch_100_batch_32_tied_True_lr_5e-05_act_None/epoch_10_step_100_all_1900/loss_model.pt"))
