...
if __name__ == '__main__':
    ...
    tail = '/2_CustomSTS_tied_noAct_histogram_finetuning/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}'
