...
if __name__ == '__main__':
    ...
    tail = '/2_CustomSTS_finetuning/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}'
    model_save_path = './output' + tail


    # Apply mean pooling to get one fixed sized sentence vector
    model = SentenceTransformer("output/CustomSTS_tied_noAct_tiedBERT/tiedBERTModel_epoch_4_batch_16_tied_True_lr_1e-05/epoch_1_step_40_all_400")
