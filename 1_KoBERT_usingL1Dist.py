...
if __name__ == '__main__':
    ...
    tail = '/CustomSTS_sigmoid_Eudist_histogram_nonscale_2dense/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}_act_{args.act}'
    ...
    train_loss = losses.CustomDistanceMSELoss(model=model, sentence_embedding_dimension=model.get_sentence_embedding_dimension(), num_labels=1, linear_num=2)
