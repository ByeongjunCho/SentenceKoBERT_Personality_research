...
if __name__ == '__main__':
    ...
    tail = '/Eudist_3_update_all/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}_act_{args.act}'
    ...
    train_loss.load_state_dict(torch.load("/home/data5/byeongjuncho/SentenceEmbedding/output/Eudist_2_tiedClassifier/1dense_epoch_100_batch_32_tied_True_lr_1e-05_act_None/epoch_99_step_100_all_17920/loss_model.pt"))
