...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='finetuning_test1', help='give a model name')
    ...
    tail = '/CustomSTS/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}'
    model_save_path = './output' + tail

    model = SentenceTransformer('./output/CustomSTS/TiedModel_epoch_4_batch_16_tied_True/epoch_0_step_140_all_140')
