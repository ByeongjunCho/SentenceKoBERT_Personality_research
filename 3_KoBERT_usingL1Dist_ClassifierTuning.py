...
if __name__ == '__main__':
    ...
    tail = '/STS_Eudist_1dense_tiedBERT/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}_act_{args.act}'
