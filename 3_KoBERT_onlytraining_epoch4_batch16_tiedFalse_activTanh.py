...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='BERTModelTraining', help='give a model name')
    ...
    tail = '/CustomSTS_usingTanh_onlyTraining/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}_activfunc_{str(args.activefunc)}'
