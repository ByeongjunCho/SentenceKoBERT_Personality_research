...
if __name__ == '__main__':
    ...
    parser.add_argument('--dropout_rate', type=float, default=0.0, help='give dropout rate')
    ...
    tail = '/CustomSTS/' + model_name.replace("/", "") + f'_epoch_{args.num_epochs}_batch_{args.batch_size}_tied_{str(args.tied)}_lr_{str(args.lr)}_dropout_{str(args.dropout_rate)}'
    ...
    train_loss = losses.CustomSoftmaxLoss(model=model, sentence_embedding_dimension=model.get_sentence_embedding_dimension(), num_labels=1)
